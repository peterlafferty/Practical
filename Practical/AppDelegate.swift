...
//        guard let topAsDetailController = secondaryAsNavController.topViewController as? PropertyViewController else { return false }
//        if topAsDetailController.property == nil {
